...
void main() {
  group('Content Management - Stats Feature', () {
    ...
    testWidgets('Stats container has padding and decoration', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Container(
    ...
    testWidgets('Stats row uses space-around alignment', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Container(
